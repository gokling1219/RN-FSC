...
img = loadmat('d:\hyperspectral_data\Botswana.mat')['Botswana']
print(img.shape)
gt = loadmat('d:\hyperspectral_data\Botswana_gt')['Botswana_gt']
...
def preparation():
    ...
    f = h5py.File(r'./data/BO-' + str(PATCH_SIZE * 2) + '-' + str(PATCH_SIZE * 2) + '-100.h5', 'w')  # 每类200个
    f['data'] = t_images
    f['label'] = t_labels
    f.close()
